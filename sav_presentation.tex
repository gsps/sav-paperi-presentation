...
\todo{This looks like a mental note to the speaker}
\item Add qualifiers
...
% \begin{itemize}
% \item 
All constrains now are of the form $\kappa \sqsubseteq L$, $L \sqsubseteq \kappa$, or $L_1 \sqsubseteq L_2$.\\
...
\end{tabular}
\end{center}
\todo{Still needs some reformatting}
